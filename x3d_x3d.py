...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 16:27:35 2021
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        # ---------------------------------------------------------------------
        # conv1 stage:
        self.conv1_s_flow = nn.Conv3d(n_input_channels, # 3
...
if __name__ == "__main__":
    ...
    input_tensor1 = torch.autograd.Variable(torch.rand(8, 3, 16, 256, 256)) # [B (base_bn_splits), C, T, W, H]
    ...
    model_path = 'X3D-M-TWO-STREAM-RENAME.pt'
